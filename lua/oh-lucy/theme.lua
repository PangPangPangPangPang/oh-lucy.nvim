...
M.plugins = {
        ...
        ["@lsp.mod.typeHint"] = { fg = colors.blue_type },
        -- ["@lsp.mod.defaultLibrary"] = { link = "Special" },
        -- ["@lsp.mod.builtin"] = { link = "Special" },


        ["@lsp.typemod.operator.controlFlow"] = { fg = colors.red_key_w },
        ...
        ["@lsp.typemod.variable.injected"] = { fg = colors.white },

        ["@lsp.typemod.function.readonly"] = { fg = colors.pink, bold = true }
}
