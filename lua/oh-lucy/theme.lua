...
M.plugins = {
        ...
        ["@parameter"]              = { fg = colors.blue_type },
        ["@parameter.reference"]    = { fg = colors.blue_type },
        ...
        -- lsp
        -----------------------------------------
        ["@lsp.type.class"]         = { link = "@variable.builtin" },
        ["@lsp.type.decorator"]     = { link = "Function" },
        ["@lsp.type.enum"]          = { link = "@variable.builtin" },
        ["@lsp.type.enumMember"]    = { link = "Constant" },
        ["@lsp.type.function"]      = { link = "Function" },
        ["@lsp.type.interface"]     = { link = "@variable.builtin" },
